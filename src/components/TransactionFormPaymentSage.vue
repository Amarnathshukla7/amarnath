<template>
  <section class="sagepay">
    <v-overlay class="text-center" :value="overlay" width="100%" height="100%">
      <h1>{{ $t("journeyUi.paymentForm.sagepay.processingMsg") }}</h1>
      <iframe
        width="100%"
        height="100%"
        src=""
    ...
    <v-row mx-4>
      <v-col cols="12" md="12">
        <v-text-field
          class="mb-0"
          :label="$t('journeyUi.paymentForm.sagepay.cardName.label')"
      ...
      <v-col cols="12" md="4">
        <v-text-field
          class="mb-0 mt-n6"
          :label="$t('journeyUi.paymentForm.sagepay.cardNumber.label')"
      ...
      <v-col cols="12" md="4">
        <v-text-field
          class="mb-0 mt-n6"
          :label="$t('journeyUi.paymentForm.sagepay.cardExpiry.label')"
          hint="MM/YY"
      ...
      <v-col cols="12" md="4">
        <v-text-field
          class="mb-0 mt-n6"
          :label="$t('journeyUi.paymentForm.sagepay.cardCvv.label')"
      ...
      <v-col cols="12">
        <v-text-field
          :label="$t('journeyUi.paymentForm.sagepay.billingAddress1.label')"
          class="mt-n6"
      ...
      <v-col cols="12">
        <v-text-field
          :label="$t('journeyUi.paymentForm.sagepay.billingAddress2.label')"
          class="mt-n6"
      ...
      <v-col cols="12">
        <v-text-field
          :label="$t('journeyUi.paymentForm.sagepay.billingCity.label')"
          class="mt-n6"
          :rules="rules.city"
      ...
      <v-col cols="12">
        <v-text-field
          :label="$t('journeyUi.paymentForm.sagepay.billingPostcode.label')"
          class="mt-n6"
      ...
      <v-col cols="12">
        <v-autocomplete
          class="mt-n6"
          :items="countries"
          :label="$t('journeyUi.paymentForm.sagepay.billingCountry.label')"
          :rules="rules.country"
      ...
      <v-col cols="12">
        <v-text-field
          ...
          :label="$t('journeyUi.paymentForm.sagepay.billingState.label')"
          outlined
        ></v-text-field>
      </v-col>
    </v-row>
    ...
    return {
      ...
      rules: {
        cardNumber: [
          (v) =>
            !!v ||
            this.$t("journeyUi.paymentForm.sagepay.cardNumber.rules").required,
          (v) => {
            ...
            return (
              pattern.test(v) ||
              this.$t("journeyUi.paymentForm.sagepay.cardNumber.rules").invalid
            );
          },
        ],
        cardExpiry: [
          (v) =>
            !!v ||
            this.$t("journeyUi.paymentForm.sagepay.cardExpiry.rules").required,
          (v) => {
            const pattern = /^(0?[1-9]|1[0-2]){1}\/(0?[1-9]|1[0-9]|2[0-9]|3[0-1]){1}$/;
            return (
              pattern.test(v) ||
              this.$t("journeyUi.paymentForm.sagepay.cardExpiry.rules.invalid")
            );
          },
          //
        ],
        cardSecurityCode: [
          (v) =>
            !!v ||
            this.$t("journeyUi.paymentForm.sagepay.cardCvv.rules.required"),
        ],
        nameOnCard: [
          (v) =>
            !!v ||
            this.$t("journeyUi.paymentForm.sagepay.cardName.rules.required"),
        ],
        address1: [
          (v) =>
            !!v ||
            this.$t(
              "journeyUi.paymentForm.sagepay.billingAddress1.rules.required",
            ),
        ],
        city: [
          (v) =>
            !!v ||
            this.$t("journeyUi.paymentForm.sagepay.billingCity.rules.required"),
        ],
        postCode: [
          (v) =>
            !!v ||
            this.$t(
              "journeyUi.paymentForm.sagepay.billingPostcode.rules.required",
            ),
        ],
        country: [
          (v) =>
            !!v ||
            this.$t(
              "journeyUi.paymentForm.sagepay.billingCountry.rules.required",
            ),
        ],
      },
    };
