...
describe("Rooms.vue", () => {
  beforeEach(() => {
    cy.intercept("GET", "search-svc/BRI/2021-08-02/2021-08-05?token=ydu67i6789yo8re57u6_test", searchJson);
    ...
    cy.intercept("POST", "cart-svc/ydu67i6789yo8re57u6_test/items", cartItemsJson);
    cy.intercept("GET", "cart-svc/ydu67i6789yo8re57u6_test/items", cartItemsJson);

    cy.intercept("DELETE", "cart-svc/ydu67i6789yo8re57u6_test/items/1000270", cartItemsDeletedJson);
    cy.intercept("DELETE", "cart-svc/ydu67i6789yo8re57u6_test/items/1000274", cartItemsDeletedJson);

    cy.intercept("DELETE", "cart-svc/ydu67i6789yo8re57u6_test/items/1000274/2021-08-02", cartItemsDeletedJson);
    cy.intercept("DELETE", "cart-svc/ydu67i6789yo8re57u6_test/items/1000274/2021-08-03", cartItemsDeletedJson);
    cy.intercept("DELETE", "cart-svc/ydu67i6789yo8re57u6_test/items/1000274/2021-08-04", cartItemsDeletedJson);

    cy.intercept("DELETE", "cart-svc/ydu67i6789yo8re57u6_test/items/1000270/2021-08-02", cartItemsDeletedJson);
    cy.intercept("DELETE", "cart-svc/ydu67i6789yo8re57u6_test/items/1000270/2021-08-03", cartItemsDeletedJson);
    cy.intercept("DELETE", "cart-svc/ydu67i6789yo8re57u6_test/items/1000270/2021-08-04", cartItemsDeletedJson);
